...
class LogsContentProvider: ContentProvider() {
    ...
    /**
     * Implement the getLogDao method that is missing from the code above. Let's use the entry point
     * interface we defined above in our LogsContentProviderEntryPoint class
     */
